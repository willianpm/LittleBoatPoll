...
export function Moderation() {
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      {isLoading && (
        <Card className="p-8 text-center dark:bg-gray-800 dark:border-gray-700 mb-6">
          <p className="text-gray-600 dark:text-gray-400">Carregando dados de moderação...</p>
        </Card>
      )}
                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
                          ...
                          <span className="truncate">Adicionado em {formatDate(mod.addedAt || '')}</span>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
                          <Calendar className="size-3" />
                          <span className="truncate">Membro desde {formatDate(sub.addedAt || '')}</span>
                        </div>
                      </div>
                    </div>
